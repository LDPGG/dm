...
def dl():
    # 你所要打开的特定目录的特定文件
    f = r'C:\\Users\\Administrator\\Desktop\\mphone.txt'
    # 把文件中的每一行作为一个元素添加到列表l1上
    phoneBad = open(f, 'r').readlines()
    for nowPhone in phoneBad:
        ...
        url_queryMemberList = 'http://39.108.195.48:8080/flyweb/member/' \
                              'queryMemberListForUpdate?pager.offset=0&pager.size=10'
        ...
        session.post(url_addMemberMoney, data=test_addMemberMoney_data)
